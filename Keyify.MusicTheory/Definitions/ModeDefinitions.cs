...
namespace Keyify.MusicTheory.Definitions
{
    public static class ModeDefinitions
    {
        public static Dictionary<Mode, Interval[]> GetScaleIntervals()
        {
            ...
            scaleIntervals.Add(Mode.Parallel, new Interval[] { Interval.R, Interval.W, Interval.h, Interval.h, Interval.h, Interval.W, Interval.h, Interval.h, Interval.h, Interval.h, Interval.h });
        ...
        public static Dictionary<Mode, string[]> GetScaleDegrees()
        {
            ...
            scaleDegrees.Add(Mode.Parallel, new string[] { Degree.First, Degree.Second, Degree.FlatThird, Degree.Third, Degree.Fourth, Degree.Fifth, Degree.FlatSixth, Degree.Sixth, Degree.FlatSeventh, Degree.Seventh, Degree.Eighth });
