...
namespace Keyify.Unit.Test.Chord.UnitTests
{
    public class ScaleToTriadUnitTest
    {
        ...
        [Theory, MemberData(nameof(IonianScales))]
        ...
        public static IEnumerable<object[]> IonianScales => GenerateIonianScales();
        ...
        private static IEnumerable<object[]> GenerateIonianScales()
        {
